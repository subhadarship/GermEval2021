...
def preprocess_data(train_df: pd.DataFrame, val_df: pd.DataFrame, test_df: Union[pd.DataFrame, None],
    ...
    # create datasets
    train_data = GermEvalDataset(df=train_df, label_col_names=label_col_names, text_field=TEXT, label_fields=LABELS,
                                 build_vocab=True, max_len=max_len)
    val_data = GermEvalDataset(df=val_df, label_col_names=label_col_names, text_field=TEXT, label_fields=LABELS,
                               build_vocab=False, max_len=max_len)
    test_data = GermEvalDataset(df=test_df, label_col_names=label_col_names, text_field=TEXT, label_fields=LABELS,
